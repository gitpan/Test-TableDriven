# This Makefile is for the Test::TableDriven extension to perl.
#
...
#     ABSTRACT => q[write tests, not scripts that run them]
#     AUTHOR => q[Jonathan Rockway C<< <jrockway AT cpan.org> >>.]
#     DIR => []
#     DISTNAME => q[Test-TableDriven]
#     NAME => q[Test::TableDriven]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Data::Dumper=>q[0] }
#     VERSION => q[0.01]
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Test/TableDriven.pm
...
TO_INST_PM = lib/Test/TableDriven.pm

PM_TO_BLIB = lib/Test/TableDriven.pm \
...
DISTNAME = Test-TableDriven
DISTVNAME = Test-TableDriven-0.01
...
manifypods : pure_all  \
	lib/Test/TableDriven.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Test/TableDriven.pm $(INST_MAN3DIR)/Test::TableDriven.$(MAN3EXT) 
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>write tests, not scripts that run them</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Jonathan Rockway C&lt;&lt; &lt;jrockway AT cpan.org&gt; &gt;&gt;.</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Test/TableDriven.pm blib/lib/Test/TableDriven.pm 
